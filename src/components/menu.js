...
import ShoppingCartIcon from '@material-ui/icons/ShoppingCart';import AppBar from './nav/AppBar';
...
const handleClick = (event) => {
    if (anchorEl){
        ...
        var button = document.getElementsByTagName('header')[0].children[0].children[0];
  ...
  return (
    <div >
      ...
      <div >
<div className={`container_for_main_menu ${anchorEl? 'm-fadeIn': 'm-fadeOut'}` } >
<div className="flex" style={{height: buttonHeight, width: buttonWidth }}>
